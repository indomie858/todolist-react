...
const Options = (props) => {
    ...
    return ( <
        ...
        div className = "optionsOption" > Default List: & nbsp; <
        select value = {
            listValue
        }
        onChange = {
            (e) => setListValue(e.target.value)
        } >
        <
        ...
        MailOutlineIcon className = {
            emailSelected ? "outlined icon" : "icon"
        }
        onClick = {
            () => {
                setEmailGlobal(!emailSelected);
        ...
        className = {
            discordSelected ? "discord outlined icon" : "discord icon"
        }
        onClick = {
        ...
        <
        button className = "addTaskInput addTaskButton"
        onClick = {
            () => logOut()
        } > Logout < /button> <
        /div> <
